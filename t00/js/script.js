...
const houseBlueprint = new houseBuilder();



houseBlueprint.roomCount = "6";

console.log(houseBlueprint);
console.log(houseBlueprint.roomCount);
...
const house = new houseBuilder('88 Crescent Avenue',
    ...
    110,
    5);
console.log(house.address);// '88 Crescent Avenue'console.log(house.description);// 'Spacious town house with wood flooring, 2-car garage, and a back patio.'
